...
<body>
    <p style="text-align: center; margin-bottom: 18pt">
        <img src="{{public_path('images/ihs.jpeg')}}" style="width: 200px;" alt=""> <br> <br>
        {{-- <strong style="font-size: 16pt">IHS Banking, Inc.</strong> <br> --}}
        Inabanga High School, Nabuad, Inabanga, Bohol<br>
        Tel. No. 09200352243334
    </p>
